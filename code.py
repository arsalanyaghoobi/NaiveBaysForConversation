    ...
    def evaluate(self, results):
        ...
        for clas in self.class_dict:
            if clas == 'RI':
                ...
                precision[clas] = confusion_matrix[0][0] / np.sum(confusion_matrix[:, 0])
            ...
            if clas == 'WD':
                ...
                precision[clas] = confusion_matrix[1][1] / np.sum(confusion_matrix[:,1])
                F1[clas] = (2 * precision[clas] * recall[clas]) / (precision[clas] + recall[clas])
                print("Precision for ", clas, " is ", precision[clas])
                print("Recall for ", clas, " is ", recall[clas])
                print("F1 for ", clas, " is ", F1[clas])
            if clas == 'RP':
                recall[clas] = confusion_matrix[2][2] / (np.sum(confusion_matrix[2,:])+ np.sum(confusion_matrix[2,3:]))
                precision[clas] = confusion_matrix[2][2] / np.sum(confusion_matrix[:,2])
                F1[clas] = (2 * precision[clas] * recall[clas]) / (precision[clas] + recall[clas])
                print("Precision for ", clas, " is ", precision[clas])
                print("Recall for ", clas, " is ", recall[clas])
                print("F1 for ", clas, " is ", F1[clas])
            if clas == 'CC':
                ...
                precision[clas] = confusion_matrix[3][3] / np.sum(confusion_matrix[:,3])
                F1[clas] = (2 * precision[clas] * recall[clas]) / (precision[clas] + recall[clas])
                print("Precision for ", clas, " is ", precision[clas])
                print("Recall for ", clas, " is ", recall[clas])
                print("F1 for ", clas, " is ", F1[clas])
            if clas == 'O':
                ...
                precision[clas] = confusion_matrix[4][4] / np.sum(confusion_matrix[:,4])
                F1[clas] = (2 * precision[clas] * recall[clas]) / (precision[clas] + recall[clas])
                print("Precision for ", clas, " is ", precision[clas])
                print("Recall for ", clas, " is ", recall[clas])
                print("F1 for ", clas, " is ", F1[clas])
